...
from agents.ddqn.ddqn_learner import DDQNLearner


class DDQN(Agent):
    """더블 DQN 알고리즘 에이전트 클래스."""
    ...
    def __init__(self,
        ...
        if env.environment_spec().b_continuous_action:
            raise Exception("DDQN doesn't support continuous action space")
